...
import com.co.sofka.models.services.ProductoService;
...
public class ApirestApplicationTests {
	...
	public void crearTest() {
		...
		Producto producto = new Producto("Sony Notebook", 100.00, categoria);
		...
		.jsonPath("$.producto.nombre").isEqualTo("Sony Notebook")
		.jsonPath("$.producto.categoria.nombre").isEqualTo("Computación");
	}
	...
	public void crear2Test() {
		...
		.consumeWith(response -> {
			...
			Assertions.assertThat(p.getId()).isNotEmpty();
			Assertions.assertThat(p.getNombre()).isEqualTo("Sony Notebook");
